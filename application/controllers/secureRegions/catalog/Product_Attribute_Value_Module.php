...
class Product_Attribute_Value_Module extends Main
{
	function __construct()
	{
		...
		$this->load->model('administrator/catalog/Product_Attribute_Value_Model');
		...
		$this->data['page_module_name']='Product Attribute Value';
		$this->data['table_name']= 'product_attribute_value';
	...
	function index()
	{
		parent::get_header();
		parent::get_left_nav();
		$this->load->view('admin/catalog/Product_Attribute_Value_Module/list' , $this->data);
		parent::get_footer();
	}
	...
	function listing()
	{
		...
		$data_count = $this->Product_Attribute_Value_Model->getData($search);
		...
		$this->data['list_data'] = $this->Product_Attribute_Value_Model->getData($search);
		// echo $this->db->last_query();
		// die();
		parent::get_header();
		parent::get_left_nav();
		$this->load->view('admin/catalog/Product_Attribute_Value_Module/listing' , $this->data);
		parent::get_footer();
	}
	...
	function export()
	{
		...
		$this->load->view('admin/catalog/Product_Attribute_Value_Module/export' , $this->data);
	}
	function pdf()
	{
		...
		$html = $this->load->view('admin/catalog/Product_Attribute_Value_Module/pdf' , $this->data,true);
		// echo $html;
		// exit;
	...
	function view($id="")
	{
		...
		$this->data['page_is_master'] = $this->data['user_access']->is_master;
		$this->data['page_parent_module_id'] = $this->data['user_access']->parent_module_id;
		$this->data['list_data'] = $this->Product_Attribute_Value_Model->getData(array("id"=>$id));
		if(empty($id))
		{
			$alert_message = ' Something Went Wrong. Please Try Again.';
			$this->session->set_flashdata('alert_message', $alert_message);
		...
		parent::get_header();
		parent::get_left_nav();
		$this->load->view('admin/catalog/Product_Attribute_Value_Module/view' , $this->data);
		parent::get_footer();
	}
	...
	function edit($id="")
	{
		...
		if(!empty($id)){
		 ...
		 $module_html = $this->load->view('admin/catalog/Product_Attribute_Value_Module/edit' , $this->data,true);
	...
	function doEdit()
	{
		...
		if(!empty($id))
		{
			...
			$this->form_validation->set_rules('product_attribute_id', 'Attribute Name', 'required');
			...
			//	print_r($is_exist);
				...
				$enter_data['product_attribute_id'] = $_POST['product_attribute_id'];
				...
				$html = $this->load->view("admin/catalog/Product_Attribute_Value_Module/edit",$this->data, true);
