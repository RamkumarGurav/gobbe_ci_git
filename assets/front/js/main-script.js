...
(function ($) {
    ...
    if ($("#slider-range").length) {
        ...
        var start_rate = document.getElementById("slider-range-value1").innerHTML;
       var end_rate =  document.getElementById("slider-range-value2").innerHTML;
    ...
    /*Carausel 4 columns*/
    $(".slider_best_sellers").each(function (key, item) {
        var id = $(this).attr("id");
        var sliderID = "#" + id;
        var appendArrowsClassName = "#" + id + "-arrows";
