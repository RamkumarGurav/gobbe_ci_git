...
class Database_Tables extends CI_Model
{
	...
	var $product_attribute_fields = array('id' , 'attributes_input_id' , 'name' , 'condition_per_product'  , 'status', 'added_on', 'added_by', 'updated_on', 'updated_by' , 'search', 'list_page', 'details_page');
	var $product_attribute_table_name = 'product_attribute';

	var $product_attribute_value_fields = array('id' , 'product_attribute_id' , 'name'  , 'color_name', 'added_on', 'updated_on', 'added_by', 'updated_by', 'status');
	var $product_attribute_value_table_name = 'product_attribute_value';

	var $category_fields = array('id' , 'super_category_id' , 'name' , 'position'  , 'cover_image', 'added_on', 'updated_on', 'added_by', 'updated_by' , 'status' , 'is_dropdown' , 'header_1_img' , 'header_1_url' , 'footer_1_img' , 'footer_1_url' , 'footer_2_img' , 'footer_2_url' , 'footer_3_img' , 'footer_3_url' , 'left_1_img' , 'left_1_url' , 'left_2_img' , 'left_2_url' , 'left_3_img' , 'left_3_url' , 'left_4_img' , 'left_4_url' , 'left_5_img' , 'left_5_url' , 'left_6_img' , 'left_6_url' , 'slug_url' , 'meta_title' , 'meta_description' , 'meta_keyword' , 'others' , 'is_outer_menu' , "description","short_description" , 'is_display_home_page');
	var $category_table_name = 'category';

	var $product_fields = array('id' , 'manufacturer_id' , 'name'  , 'ref_code', 'slug_url', 'short_description', 'description', 'how_to_use', 'status' , 'added_on'  , 'added_by', 'updated_on', 'updated_by', 'tax_categories_id', 'tax_providers_id' , 'hsn_code' , 'is_sell_local' , 'is_bulk_enquiry' , 'product_sell_to');
	var $product_table_name = 'product';

	var $product_category_fields = array('id' , 'product_id' , 'category_id');
	var $product_category_table_name = 'product_category';

	var $product_image_fields = array('id' , 'product_id' , 'product_image_name' , 'default_image'  , 'status', 'added_on', 'added_by', 'updated_on', 'updated_by');
	var $product_image_table_name = 'product_image';

	var $product_combination_attribute_fields = array('id' , 'product_id' , 'product_combination_id' , 'product_attribute_id'  , 'product_attribute_value_id', 'combination_value');

	var $product_combination_attribute_table_name = 'product_combination_attribute';

	public $product_combination_fields = array('id' , 'ref_code' , 'product_id'  ,'uom_id', 'product_image_id', 'quantity', 'product_weight', 'product_dimension' , 'price', 'discount', 'discount_var', 'final_price' , 'comb_slug_url' , 'status'  , 'added_on', 'added_by', 'updated_on', 'updated_by', 'trending_now', 'hot_selling_now', 'best_sellers', 'new_product', 'product_weight', 'product_dimension', 'product_l', 'product_b', 'product_h', 'current_viewers_msg', 'current_sold_msg', 'is_msg_dynamic', 'product_display_name' , 'delivery_charges' , 'gtin' , 'is_google_product');
	public $product_combination_table_name = 'product_combination';



	var $product_in_store_fields = array('id' , 'store_id' , 'product_id'  , 'product_combination_id', 'quantity' , 'quantity_per_order' , 'stock_out_msg', 'price', 'discount', 'discount_var', 'final_price' , 'status'  , 'admin_status', 'added_on', 'updated_on', 'added_by', 'updated_by');
	...
	var $product_seo_fields = array('id' , 'product_id' , 'product_combination_id'  , 'store_id', 'product_in_store_id', 'slug_url', 'meta_title', 'meta_description', 'meta_keywords' , 'others');
