...
<div class="login-box">
  <div class="login-logo">
    <!-- <a href="<? echo _lte_files_ ?>index2.html"><?php echo _project_complete_name_ ?></a> -->
		<img src="<?php echo MAINSITE."assets/front/images/logo.png"  ?>" style="height:150px">
  </div>
  <!-- /.login-logo -->
  <div class="card">
      ...
      <p class="login-box-msg">Enter Email / User Name To Reset Password</p>
        ...
        <div class="row">
          ...
          <div class="col-4">
					...
					<div class="col-4">
					  <centre><button type="button" onclick="forgot_password_func()"name="login_btn" value="1" class="btn btn-primary btn-block">Reset Pssword</button></centre>
          </div>
					<div class="col-4">
          </div>
          <!-- /.col -->
