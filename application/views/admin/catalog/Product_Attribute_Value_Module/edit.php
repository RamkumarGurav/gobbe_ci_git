...
<div class="tpi-add-attr">
  ...
  <div class="ttc-pro-inner">
		...
		<div class="form-group">
			<?php
								echo form_label('Attribute Name', 'product_attribute_id');
								?>
								<?php
								$value = set_value('product_attribute_id');
												if(!empty($value)){$product_attribute_id = $value; }
												if(empty($value)){$value = $product_attribute_id;}
									$attributes = array(
								...
								?>
								<span>
												<?php echo form_error('product_attribute_id', '<div class="error" style="color: red">', '</div>'); ?>
										</span>
		</div>
		<div class="form-group">
				<?php
