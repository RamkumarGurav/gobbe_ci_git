    ...
    if(empty($value)){
      ...
      if(empty($value)){
        $value = (!empty($address_data[0]->alternate_number))?$address_data[0]->alternate_number:'';
           ...
           <div class="radio-btn-manage mt-5 mb-5">
            <p >Address Type</p>
...
<br><br>
          <div class="save-btns mt-5" style="margin:-top:50px !important">
            <button type="submit" id="submit" name="AddressSaveBTN" value="1" class="save-btn">Save </button>
            <button class="cancel-btn btn cancelBTN" type="button" tabindex="11" data-id="<?=$customers_address_id?>">CANCEL</button></div>
          </div>
        <?php echo form_close() ?>
      </div>
