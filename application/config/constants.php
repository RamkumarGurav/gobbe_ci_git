...
define('_project_name_', "Gobbe");
define('_brand_name_', "GOBBE");
...
define('_project_contact_whatsapp_message_',"Welcome to Gobbe");
define('_project_email_',"info@gobbe.in");
define('__adminemail__',"info@gobbe.in");
define('__adminsms__', "919177175622");  // for Register
define('_project_web_',"www.gobbe.in");
define('__order_initial__',"GIPL");
define('_SMS_BRAND_',"www.gobbe.in");
define('__GSTIN__', "36AKRPG7758C2ZS");
define('_FACEBOOK_',"https://www.facebook.com");
define('_INSTAGRAM_',"https://instagram.com");
define('_TWITTER_',"");
define('_PININTEREST_',"");
define('_YOUTUBE_',"https://youtube.com");
define('_PINTEREST_',"");
define('_LINKEDIN_',"");
...
define('ADMINCSS',$ark_root."assets/admin/css/");
define('ADMINJS',$ark_root."assets/admin/js/");
...
define('__profileInformation__', "personal-information");  // for Profile Info
...
define('__from_email__', "noreply@gobbe.in");

define('_project_complete_name_', "Gobbe"); # to display
