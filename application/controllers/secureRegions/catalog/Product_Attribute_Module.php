...
class Product_Attribute_Module extends Main
{
	function __construct()
	{
		...
		$this->data['page_module_name']='Product Attribute';
		$this->data['table_name']= 'product_attribute';
	...
	function listing()
	{
		...
		$data_count = $this->Product_Attribute_Model->getData($search);
		...
		$this->data['list_data'] = $this->Product_Attribute_Model->getData($search);
	...
	function export()
	{
		...
		$this->load->view('admin/catalog/Product_Attribute_Module/export' , $this->data);
	}
	function pdf()
	{
		...
		$html = $this->load->view('admin/catalog/Product_Attribute_Module/pdf' , $this->data,true);
		// echo $html;
		// exit;
	...
	function view($id="")
	{
		...
		$this->data['page_is_master'] = $this->data['user_access']->is_master;
		$this->data['page_parent_module_id'] = $this->data['user_access']->parent_module_id;
		$this->data['list_data'] = $this->Product_Attribute_Model->getData(array("id"=>$id));
		if(empty($id))
		{
			$alert_message = ' Something Went Wrong. Please Try Again.';
			$this->session->set_flashdata('alert_message', $alert_message);
	...
	function edit($id="")
	{
		...
		if(!empty($id)){
		 ...
		 $module_html = $this->load->view('admin/catalog/Product_Attribute_Module/edit' , $this->data,true);
	...
	function doEdit()
	{
		...
		if(!empty($id))
		{
			...
			//	print_r($is_exist);
				...
				$html = $this->load->view("admin/catalog/Product_Attribute_Module/edit",$this->data, true);
