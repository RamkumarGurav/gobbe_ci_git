...
if(!empty($products_list))
{
  ...
  //        $product_link .= base_url();
    ...
    <? }else{
			$animate_class = ' animate__animated animate__fadeIn';
			$animate_delay = 'data-wow-delay=".1s"';
			?>
	 ...
	 <div class="col-lg-<?=$_prow_count?> col-md-<?=$_prow_count?> col-12 col-sm-<?=$_prow_count?>">
        ...
        <? } ?>
								 ...
								 <div class="product-cart-wrap mb-30 <?=$animate_class?>" <?=$animate_delay?>>
										 <div class="product-img-action-wrap">
												 ...
												 <div class="product-action-1">
													 ...
													 <a  aria-label='Remove From Wishlist'  class="action-btn hover-up crt_button3 wishlist-i cart_wishlist_<? echo $product_in_store_id; ?> cart_wishlist_y_<? echo $product_in_store_id; ?> addToWishlistListBTN<? echo $offset ?>" data-val="<? echo $product_in_store_id; ?>,<? echo $product_id; ?>,<? echo $product_combination_id; ?>,2" title="Remove from Wishlist - <? echo $product_name; ?> - <? echo str_replace('&nbsp;' , ' ' , $combi); ?>" style=" <? if ($prod_in_wishList >= 1) {echo " display:inline-block";} else {echo "display:none";} ?> " ><i class="fa fa-heart"></i></a>
														 ...
														 <a aria-label="Quick view" onclick="product_quick_view_func(<?=$product_id?> , <?=$product_combination_id?>)" title="Quick View - <? echo $product_name; ?> - <? echo str_replace('&nbsp;' , ' ' , $combi); ?>" class="addToview action-btn" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="fa fa-eye"></i></a>
												 </div>
												 <?
												 if($hot_selling_now){
													 ?>
										 ...
										 <div class="product-content-wrap">
												 ...
												 <div class="product-rate-cover">
														 ...
														 <span class="font-small  text-success"> (<?=$att_values?>)</span>
														  <div class="product-rate-cover1 mt-2 ">
														 <div class="  row d-flex">

																								<!-- <div class="rating-block"> -->
																									<div class="col-md-12" >
																									<div class="starrr_myBtn d-flex">
																										<div class="star-rating rating-sm">
																											...
																											?>
																											 <span class="font-small  text-muted"> (<? echo empty($avgrating)?'0':round($avgrating,1)?>)</span>
