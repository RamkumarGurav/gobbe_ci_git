<div class="dsm-main-content">
    <div class="cmc-tab">
        ...
        <div class="tpi-active" >
            <a onclick="validateRecordsActivate()" class="btn btn-info"><i class="fas fa-check"></i>
                Active</a>
        </div>
        <div class="tpi-block" >
            <a onclick="validateRecordsBlock()"class="btn btn-secondary"><i class="fas fa-ban"></i>
                Block</a>
        </div>
        <?
        }
